 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |Grv/L1|      | LGui | App  |      |                                       | Left |  Up  | Down |Right |  \_  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | Del  | Home |       | PgUp | Ctrl |
 *                                 ,------|------|------|       |------+------+------.
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        LT(SYMB,KC_GRV),KC_NO,        KC_LGUI,ALT_T(KC_APP),  KC_NO,
                                                      KC_DELT,KC_HOME,
                                                              KC_END,
                                               KC_SPC,KC_BSPC,KC_MHEN,
        // right hand
             ...
             KC_BSLS,     KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,          KC_RSFT,
                                  KC_LEFT,KC_UP  ,KC_DOWN,KC_RGHT,          KC_RO,
             KC_PGUP,KC_RCTL,
             KC_PGDN,
             KC_HENK,KC_ENT, KC_SPC
    ),
/* Keymap 1: Symbol Layer
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * | PrScr  |  F1  |  F2  |  F3  |  F4  |  F5  |      |           |      |  F6  |  F7  |  F8  |  F9  |  F10 |   Del  |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * | ScrLk  |      |      |      |      |      |      |           |      |      |   7  |   8  |   9  |   *  |   F11  |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * | Pause  |      |      |      |      |      |------|           |------|      |   4  |   5  |   6  |   +  |   F12  |
...
[SYMB] = KEYMAP(
       ...
       KC_TRNS, KC_TRNS, KC_7,   KC_8,    KC_9,    KC_ASTR, KC_F11,
                KC_TRNS, KC_4,   KC_5,    KC_6,    KC_PLUS, KC_F12,
