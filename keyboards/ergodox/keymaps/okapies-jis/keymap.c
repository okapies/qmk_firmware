 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |Grv/L1| ZKHK | LGui | App  | MHEN |                                       | HENK | Left | Down |  Up  | Right|
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | Del  |  L1  |       |  L2  |  Ctrl  |
 *                                 ,------|------|------|       |------+--------+------.
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        LT(SYMB,KC_GRV),KC_ZKHK,      KC_LGUI,ALT_T(KC_APP),  KC_MHEN,
                                                      KC_DELT,TG(SYMB),
                                                              KC_HOME,
                                               KC_SPC,KC_BSPC,KC_END,
        // right hand
             KC_JYEN,     KC_6,   KC_7,  KC_8,   KC_9,   KC_0,             KC_BSPC,
             KC_QUOT,     KC_Y,   KC_U,  KC_I,   KC_O,   KC_P,             KC_LBRC,
